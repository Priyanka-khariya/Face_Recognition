...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\karan\face recognition\FR\Images\bgg.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame1= Frame(self.root,bg="#FFF2F2")
        frame1.place(x=560,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\karan\face recognition\FR\Images\65-651790_user-icon-login-logo.png")
        img1=img1.resize((100,100),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="#FFF2F2")
        lb1img1.place(x=690,y=175, width=100,height=150)

        get_str = Label(frame1,text="Login",font=("times new roman",20,"bold"),fg="white",bg="#FFF2F2")
        get_str.place(x=140,y=100)

        title_lbl=Label(lb1_bg,text="FACE RECOGNITION ATTENDANCE SYSTEM SOFTWARE",font=("times new roman",35,"bold"),bg="white", fg="black")
        title_lbl.place(x=0,y=0,width=1540,height=60)

        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFF2F2")
        ...
        #label2 
        pwd =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFF2F2")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#FFF2F2",bg="#000000",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=320,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#000000",bg="#FFF2F2",activeforeground="white",activebackground="#002B53")
        loginbtn.place(x=33,y=370,width=50,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#000000",bg="#FFF2F2",activeforeground="white",activebackground="#002B53")
...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # # student button 1
        std_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        hlp_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        # Start below buttons.........
        #  Train   button 5
        tra_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (7).jpg")
