...
class Train:
    def __init__(self,root):
        ...
        #img_top=Image.open(r"C:\Users\karan\face recognition\FR\Images\OIP (2).jpg")
...
#        f_lbl=Label(self.root,image=self.photoimg_top)
 #       f_lbl.place(x=0,y=55,width=1530,height=325)
        ...
        img_bottom=Image.open(r"C:\Users\karan\face recognition\FR\Images\reccc.jpg")
        ...
        b1.place(x=0,y=650,width=1530,height=60)
