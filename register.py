...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\karan\face recognition\FR\Images\225676.jpg")
        ...
        title_lbl=Label(lb1_bg,text="REGISTER HERE!",font=("times new roman",35,"bold"),bg="white", fg="black")
        ...
        self.txtpwd.place(x=103,y=235,width=210)
